...
class ErrorHandler {
    ...
    private fun createErrorResponse(response: HttpServletResponse, exception: Exception, statusCode: HttpStatus, shouldLog: Boolean): ResponseEntity<ErrorResponse> {
        ...
        return ResponseEntity(ErrorResponse(correlationId, exception::class.simpleName!!, statusCode.name, statusCode.value(), message), statusCode)
